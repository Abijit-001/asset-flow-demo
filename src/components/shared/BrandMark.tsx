...
/**
 * The wordmark is drawn as a printed asset tag -- punch hole on a coloured
 * field -- because that is the physical object this software replaces. It is
 * the one decorative element in the app; everything around it stays plain.
 *
 ...
 */
const TONES: Record<Tone, { chip: string; hole: string }> = {
  default: {
